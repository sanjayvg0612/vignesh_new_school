...
export default function BulkUploadPage() {
  ...
  const handleUpload = async () => {
    ...
    setError('')
    try {
      const res = await studentApi.bulkUpload(getSchoolId(), file)
  ...
  return (
    <div>
      <PageHeader
        title="Bulk Upload"
        subtitle="Upload multiple students at once using a CSV or Excel file"
      />
      ...
      <div className="card p-6 max-w-2xl">
            ...
            <div className="grid grid-cols-2 gap-3 mt-2">
              {result.created != null && (
                <div className="bg-gray-50 rounded-lg p-4 text-center border border-gray-200">
                  ...
                  <p className="text-xs text-gray-500 mt-1">Students Created</p>
                </div>
              )}
              {result.skipped != null && (
                <div className="bg-gray-50 rounded-lg p-4 text-center border border-gray-200">
        ...
        <div className="mt-6 border-t border-gray-100 pt-4">
          ...
          <div className="flex flex-wrap gap-1.5">
            {['first_name','last_name','email','phone','gender','dob','class_id','section_id',
              'roll_number','guardian_name','guardian_phone','guardian_email'].map(col => (
